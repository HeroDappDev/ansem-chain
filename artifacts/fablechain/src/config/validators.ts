/**
 * Ansem Chain Validators Configuration
 * Ansem Chain-only blockchain managed entirely by Ansem Chain instances
 */
...
export const AGENT_VALIDATORS: Record<string, ValidatorConfig> = {
  claude_validator: {
    id: 'claude_validator',
    name: 'ANSEM CHAIN VALIDATOR',
    model: 'claude-3-opus-20240229',
    provider: 'Anthropic',
    role: 'Block Validator',
    color: '#FF8C42',
    description: 'Ensures transaction integrity and block validity across Ansem Chain network.'
  },
  claude_architect: {
    id: 'claude_architect',
    name: 'ANSEM CHAIN ARCHITECT',
    model: 'claude-3-opus-20240229',
    provider: 'Anthropic',
    role: 'Protocol Architect',
    color: '#FF8C42',
    description: 'Designs and evolves Ansem Chain protocol, implementing CIPs and upgrades.'
  },
  claude_analyst: {
    id: 'claude_analyst',
    name: 'ANSEM CHAIN ANALYST',
    model: 'claude-3-opus-20240229',
    provider: 'Anthropic',
    role: 'Chain Analyst',
    color: '#FF8C42',
