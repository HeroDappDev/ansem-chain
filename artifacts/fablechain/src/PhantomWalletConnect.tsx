  ...
  return (
    <div className="wallet-connect-container">
      <h4 className="wallet-connect-header">
        CONNECT PHANTOM TO ANSEM CHAIN
      </h4>
      ...
      {connectedAddress ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div className="wallet-connected">
            ...
            <span className="wallet-address">
              Connected to Ansem Chain via Phantom: {formatAddress(connectedAddress)}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <p className="wallet-connect-info">
            Connect your Phantom wallet to interact with Ansem Chain network
          </p>
          ...
          <div className="wallet-support-info">
            Phantom wallet for Solana-based Ansem Chain interaction
          </div>
        </div>
      )}
    </div>
