      ...
      {connectedAddress ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div className="wallet-connected">
            ...
            <span className="wallet-address">
              Connected to Ansem Chain: {formatAddress(connectedAddress)}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <p className="wallet-connect-info">
            Connect your Web3 wallet to interact with Ansem Chain network
          </p>
          ...
          >
            {isConnecting ? 'CONNECTING TO ANSEM CHAIN...' : 'CONNECT TO ANSEM CHAIN'}
          </button>
          
          <div className="wallet-support-info">
            Supported: MetaMask (Ethereum) and Phantom (Solana) for Ansem Chain interaction
          </div>
        </div>
      )}
    </div>
