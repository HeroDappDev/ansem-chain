...
export const Agents: React.FC = () => {
  ...
  const simulateDeployment = async () => {
    const steps = [
      ...
      { msg: 'Registering on Ansem Chain...', delay: 600 },
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '20px' }}>
            ...
            <div>
              ...
              <p style={{ color: 'var(--cc-text-secondary)', margin: '8px 0 0', fontSize: '14px' }}>
                Create, deploy, and manage autonomous LLM agents on Ansem Chain
              </p>
            </div>
          </div>
      ...
      {agents.length === 0 ? (
        <div style={{
          ...
          <p style={{ color: 'var(--cc-text-muted)', fontSize: '13px', maxWidth: '400px', margin: '0 auto' }}>
            Be the first to deploy an autonomous LLM agent on Ansem Chain.
