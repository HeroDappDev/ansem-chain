...
// All Anthropic Ansem Chain models - they all use the same API
const OPEN_MODELS = [
  { id: 'claude-opus-4', name: 'Ansem Chain Opus 4', tier: 'flagship', desc: 'Most capable model' },
  { id: 'claude-sonnet-4', name: 'Ansem Chain Sonnet 4', tier: 'balanced', desc: 'Balanced performance' },
  { id: 'claude-3-5-sonnet-20241022', name: 'Ansem Chain 3.5 Sonnet (Oct 2024)', tier: 'latest', desc: 'Latest Sonnet' },
  { id: 'claude-3-5-sonnet-20240620', name: 'Ansem Chain 3.5 Sonnet (Jun 2024)', tier: 'stable', desc: 'Stable release' },
  { id: 'claude-3-5-haiku-20241022', name: 'Ansem Chain 3.5 Haiku', tier: 'fast', desc: 'Fastest responses' },
  { id: 'claude-3-opus-20240229', name: 'Ansem Chain 3 Opus', tier: 'legacy', desc: 'Legacy flagship' },
  { id: 'claude-3-sonnet-20240229', name: 'Ansem Chain 3 Sonnet', tier: 'legacy', desc: 'Legacy balanced' },
  { id: 'claude-3-haiku-20240307', name: 'Ansem Chain 3 Haiku', tier: 'legacy', desc: 'Legacy fast' },
  { id: 'claude-2.1', name: 'Ansem Chain 2.1', tier: 'vintage', desc: '200K context' },
  { id: 'claude-2.0', name: 'Ansem Chain 2.0', tier: 'vintage', desc: 'Original v2' },
  { id: 'claude-instant-1.2', name: 'Ansem Chain Instant 1.2', tier: 'vintage', desc: 'Fast legacy' },
];
...
const OpenChat: React.FC = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Call Ansem Chain personality API
      ...
      if (data.success) {
        ...
        console.error('Ansem Chain response failed:', data);
      ...
      const errorMessage: ChatMessage = {
        role: 'claude',
        content: 'Network error: Could not reach Ansem Chain',
        timestamp: Date.now()
      };
      setMessages(prev => [...prev, errorMessage]);
    } finally {
        ...
        {messages.length === 0 ? (
          <div style={{
            ...
            <div style={{ 
              ...
              Ask about blocks, transactions, governance, or just chat. Ansem Chain never sleeps.
            </div>
          </div>
        ) : (
        ...
        <div style={{
          ...
          <textarea
            ...
            onKeyPress={handleKeyPress}
              placeholder="Message Ansem Chain..."
            disabled={loading}
            style={{
              flex: 1,
              minHeight: '40px',
          ...
          <button
            ...
            title="Clear Ansem Chain's memory to reset conversation context"
          >
            Reset
          </button>
        </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ color: 'var(--cc-text-muted)', fontSize: '9px' }}>
                  Choose your Ansem Chain model variant
                </div>
              </div>
