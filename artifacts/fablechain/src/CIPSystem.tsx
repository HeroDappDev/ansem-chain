        ...
        <div style={{ marginBottom: '20px' }}>
          <div style={{ 
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button
                onClick={() => {
                  const transcript = `Ansem Chain Improvement Proposal Transcript
==================================================
ID: ${selectedCIP.id}
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h1 style={{ 
          ...
          ANSEM CHAIN IMPROVEMENT PROPOSALS
        </h1>
      </div>
